...
// Mengambil data dari table dosen dari nip yang tidak sama dengan 0
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Dosen</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        <div class="col">
                            ...
                            <select class="form-select" id="homebase" name="homebase">
                                ...
                                <option value="1" <?php if ($dosen['homebase'] == '1') {  echo "selected"; } ?>>
                                    D3-Teknik Telekomunikasi
                                </option>
                                <option value="2" <?php if ($dosen['homebase'] == '2') {  echo "selected"; }  ?>>
                                    D4-Teknik Telekomunikasi</option>
                                <option value="3" <?php if ($dosen['homebase'] == '3') {  echo "selected"; } ?>>
                                    MST-Teknik Telekomunikasi</option>
                            </select>
                        </div>
                        <div class="mb-3 col">
                            <label for="tlp" class="form-label">Telepon</label>
                            <input type="text" class="form-control" id="tlp" value="<?= $dosen['tlp']; ?>" name="tlp"
                                autocomplete="off" required>
                        </div>
                        <div class="col-lg">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" value="<?= $dosen['email']; ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="alamat" rows="5" name="alamat"
                            autocomplete="off"><?= $dosen['alamat']; ?></textarea>
                    </div>
                    <hr>
