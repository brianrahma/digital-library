...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active" aria-current="page" href="#">Mahasiswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
                <a href="addData.php" class="btn text-white" style="background-color:#6c63ff"><i
                ...
                <table id="data" class="table table-striped table-responsive table-hover text-center"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['alamat']; ?></td>
                            <td>
                                <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['nim']; ?>"
                                ...
                                <a href="hapus.php?nim=<?= $row['nim']; ?>" class="btn btn-danger btn-sm"
                                    ...
                                    onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nim']; ?> ?');"><i
